...
import org.jesperancinha.car.lease.converters.toDate
...
class CustomerService(private val customerRepository: CustomerRepository) {
    fun createCustomer(customerDto: CustomerDto): CustomerDto? = customerRepository.save(customerDto.toDate()).toDto()
    fun getCustomerById(id: Long?): CustomerDto? = null
    fun updateCustomer(customerDto: CustomerDto): CustomerDto? = customerRepository.save(customerDto.toDate()).toDto()
