...
import (
	...
	"github.com/jesperancinha/qa-mastering-apps/go-lang/supermarket-with-features/internal/model"
	"log"
	"net/http"
)
...
func main() {
	...
	log.Println("Supermarket with Features Server starting on port 8080...")
